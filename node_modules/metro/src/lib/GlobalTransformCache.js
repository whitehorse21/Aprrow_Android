...
class OptionsHasher {
  ...
  {const
    ...
    options.enableBabelRCLookup,dev = options.dev,hot = options.hot,inlineRequires = options.inlineRequires,minify = options.minify,platform = options.platform,projectRoot = options.projectRoot,unknowns = _objectWithoutProperties(options, ['enableBabelRCLookup', 'dev', 'hot', 'inlineRequires', 'minify', 'platform', 'projectRoot']);
