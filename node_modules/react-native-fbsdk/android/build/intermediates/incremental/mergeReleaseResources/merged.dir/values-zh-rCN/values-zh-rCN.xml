...
<resources xmlns:ns1="urn:oasis:names:tc:xliff:document:1.2">
    ...
    <string gender="unknown" name="com_facebook_device_auth_instructions">请访问&lt;b>facebook.com/device&lt;/b>并输入以上验证码。</string>
    ...
    <string gender="unknown" name="com_facebook_loginview_log_in_button_continue">前往 Facebook</string>
    <string gender="unknown" name="com_facebook_loginview_log_in_button_long">使用 Facebook 登录</string>
    <string gender="unknown" name="com_facebook_loginview_log_out_action">注销</string>
    <string gender="unknown" name="com_facebook_loginview_log_out_button">注销</string>
