...
import {AsyncStorage,Linking,ActivityIndicator,BackHandler,WebView, CheckBox, StyleSheet, Text, View, TextInput, Button, ScrollView, ToastAndroid, Image,KeyboardAvoidingView,AppRegistry,ToolbarAndroid,SectionList, TouchableOpacity  } from 'react-native';
...
export default class Help extends React.Component {
  static navigationOptions = ({ navigation }) => {
    ...
    let title= Strings.help_page_head;
  ...
  async handleBackButtonClick() 
    ...
    {
              this.mixpanelTrack("Help Center View");
