...
async function setprofiledata()
{
 ...
 export default function Menu({ onItemSelected }) {
  ...
  setprofiledata();
        ...
        //var imagereturnD= databasehelper.getProfileImage();
        // var imageData=imagereturnD.res;
       ...
       /*  var imageBase64=imageData[0].profileimage;         
        if(imageBase64!='0' && imageBase64!='' && imageBase64!=null && imageBase64!='fgdfhdfhhgfgh' )
        {
          ...
          */
        //var userData= databasehelper.getUser();
       // firstname=userData.res[0].firstname;
        //UserName=userData.res[0].username;
        /*
         this.setState({                
  ...
  return (
    ...
    {/*
      <TouchableOpacity onPress={() => onItemSelected('Devices')}>
      <View style={{flexDirection:'row',marginLeft:20,marginTop:10,marginBottom:10}}>
        <Image source={require('./assets/icon_devices_blue.png')}  style={{height: 15, width: 15,marginTop: 4,marginBottom: 1,marginRight:10}}   /> 
      <Text  style={styles.item}>Devices</Text>
      </View>
      </TouchableOpacity>
    */}
      ...
      {/*
      <TouchableOpacity onPress={() => onItemSelected('About')}>
      <View style={{flexDirection:'row',marginLeft:20,marginTop:10,marginBottom:10}}>
        <Image source={require('./assets/icon_dashboard_blue.png')}  style={{height: 15, width: 15,marginTop: 4,marginBottom: 1,marginRight:10}}   /> 
  ...
  {/*    <TouchableOpacity onPress={() => onItemSelected('Settings')}>
      <View style={{flexDirection:'row',marginLeft:20,marginTop:10,marginBottom:10}}>
        <Image source={require('./assets/icon_settings_blue.png')}  style={{height: 15, width: 15,marginTop: 4,marginBottom: 1,marginRight:10}}   /> 
      ...
      <View style={{flexDirection:'row',marginLeft:20,marginTop:10,marginBottom:10}}>
        <Image source={require('./assets/icon_help_blue.png')}  style={{height: 15, width: 15,marginTop: 4,marginBottom: 1,marginRight:10}}   /> 
      <Text  style={styles.item}>Help Center</Text>
      </View>
    </TouchableOpacity>  */}
