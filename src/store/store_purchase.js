          ...
          <View style={{ flexDirection: "row", flex: 1, marginTop: 2, marginLeft: '8%', marginTop: '2%' }}>
            ...
            <View style={{ flex: 1, height: "50%", width: "50%", flexDirection: "column", marginTop: '-6.5%', marginLeft: '2%',justifyContent:'space-between' }}>
              <View style={{ alignItems: "center", justifyContent: "center", alignSelf: "center" }}>
                ...
                <Text allowFontScaling={false} style={{ marginTop: this.state.istab == true ? -31 : '-22%', fontSize: 17, marginLeft: this.state.istab == true ? '16%' : '11%', color: "white" }} onPress={() => this.downloadstax("payment")} >{this.state.priceUnit} {this.state.price}</Text>
              </View>
