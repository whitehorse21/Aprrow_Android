...
import {Linking, View, Button, ScrollView, Dimensions, TouchableOpacity, Image, StyleSheet, Text, TextInput, FlatList, AsyncStorage } from "react-native";
...
export default class storesearch extends Component {
    ...
    static navigationOptions = ({ navigation }) => {
        ...
        var devH = Dimensions.get('window').height;
        let showsearchbar = params.showsearch;
            ...
            <View
              ...
              />*/}
                    <View style={{ width: '70%',paddingLeft:'8%' }}>
                        <TextInput
                            style={{ color: "white" }}
                            placeholder={Strings.discoversearch_page_head}
            ...
            <View style={{ flex: 1, backgroundColor: "white" }}>
                ...
                {commons.renderIf(!this.state.searchview,
                    <View style={{ alignItems: "center", marginTop: 200 }}>
                        <Text allowFontScaling={false} allowFontScaling={false} style={{ fontSize: 15, color: "#1a8cff" }}>{Strings.discoversearch_page_showsearch}</Text>
                        <Text allowFontScaling={false} allowFontScaling={false} style={{ fontSize: 15, color: "#1a8cff" }}>{Strings.discoversearch_page_showsearch1}</Text>
                ...
                {commons.renderIf(this.state.searchview,
                    <View style={{ flex: 1, marginLeft:'2%', marginRight: '2%', marginTop: 5 }}>
                        <FlatList
                            ...
                            numColumns={3}
                            style={{ flex: 1 }}
                            //ListFooterComponent={commons.renderIf(this.state.last_key_val_mapping.hasOwnProperty("lastevlkey"), <TouchableOpacity onPress={() => this.search(true)} style={{ marginTop: 15, alignItems: "center", justifyContent: "center", height: 40, width: 100, backgroundColor: "blue", marginRight: 15 }}><Text allowFontScaling={false} allowFontScaling={false} style={{ color: "white" }}>See More</Text></TouchableOpacity>)}
                            renderItem={({ item }) =>
